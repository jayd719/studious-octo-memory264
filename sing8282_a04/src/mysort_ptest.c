...
static float test_data[MAX_LEN] = { 5, 4, 3, 2, 1, 3, 1, 4, 1, 5, 3, 1, 4, 5, 2,
		7, 6, 9, 8, 0, 1, 4, 2, 8, 5, 7 };

static int tests[][2] = { { 0, 4 }, { 5, 9 }, { 10, 19 }, { 20, 25 } };
