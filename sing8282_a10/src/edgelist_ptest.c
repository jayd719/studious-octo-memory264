...
//} EDGE;
//
//EDGE tests[] = { { 0, 2, 3 }, { 2, 1, 4 }, { 1, 3, 9 }, { 1, 4, 11 } };
//
...
//		printf("%s(%d %d %d): ", "insert_edge_start", tests[i].from,
//				tests[i].to, tests[i].weight);
//		display_edgelist(elg);
//		printf("\n");
//	}
//	printf("\n");
...
//		printf("%s(%d %d %d): ", "insert_edge_end", tests[i].from, tests[i].to,
//				tests[i].weight);
//		display_edgelist(elg);
//		printf("\n");
//	}
...
//		printf("%s(%d %d): ", "delete_edge", delete_tests[i].from,
//				delete_tests[i].to);
//		display_edgelist(elg);
//		printf("\n");
//	}
