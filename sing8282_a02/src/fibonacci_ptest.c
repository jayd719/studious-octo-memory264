...
//	printf(
//			"time_span(dpbu_fibonacci(%d))/time_span(iterative_fibonacci(%d)):%0.1f\n",
//			n, n, (time_span3 / time_span1) * (m1 / m3));
//	printf(
//			"time_span(dptd_fibonacci(%d))/time_span(iterative_fibonacci(%d)):%0.1f\n",
//			n, n, (time_span4 / time_span1) * (m1 / m4));
//	printf(
//			"time_span(recursive_fibonacci(%d))/time_span(dptd_fibonacci(%d)):%0.1f\n",
